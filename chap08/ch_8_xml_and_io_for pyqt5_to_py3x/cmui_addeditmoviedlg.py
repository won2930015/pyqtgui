...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.plainTextEdit)
        ...
        Dialog.setTabOrder(self.spinBox_2, self.dateEdit)
        Dialog.setTabOrder(self.dateEdit, self.lineEdit_2)
        Dialog.setTabOrder(self.lineEdit_2, self.plainTextEdit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "地点"))
